...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tournaments Planet - Help</title>
    ...
    <body class="antialiased">
        <div class="relative d-flex items-top justify-left min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="background:#EDE5E3">
            ...
            <!-- main section -->
            <!-- Help -->
            <div class="flex justify-center pt-8 sm:justify-center sm:pt-0 panel">
                <h1 class="lobster fontsevenvh" style="color:#FEF8F4;">
                    Help
                </h1>
            </div>
                        ...
                        <div class=" ml-12 mr-12">
                            <div class="ml-12 text-lg">
                                <h1 class="fontawesome shadow">
                                    Welcome to Tournaments Planet!
                                </h1>
                                <p style="color: #B16487">
                                
                                    Do you want to keep having fun with your family and friends but <strong> take it up a notch</strong>? In this application, you will be able to track player's scores, times, and even create your own goals in any type of game or activity where you can and count points.
                                    <br>
                                    <br>
                                    
                                    Using Tournaments Planet is very simple, it can be resumed in three steps:
                                    <br>
                                </p>
            ...
            <div class="mainbg d-flex items-center">
                ...
                <div class="accordion-content mt-2 ml-12">
                    <p>
                        ...
                        <br><br>
                        <b>A word of explanation on the particular parameter of Targets: "Factors" - the application allows to define three different 'weights' for each shot: Missed (factor 0), Hit (factor 1) and Bullseye (factor 2).</b>
                        <br><br>
                        When a player misses a target, the button <b>'Missed'</b> will multiply the number of points for that target shot by ZERO.
                        <br><br>
                        If the player hits the target, but not a bullseye or hits it indirectly by a ricochet (also called 'dirty shot'), the Officer can record a <b>'Hit'</b> for that specific target, which multiplies the number of points for that target shot by ONE.
                        <br><br>
                        Now, if the player hits the target bullseye (very precise shot), the Officer may consider it a <b>'Bullseye'</b>, which marks the shot by multiplying the number of points of that target shot by TWO.
                        <br><br>
